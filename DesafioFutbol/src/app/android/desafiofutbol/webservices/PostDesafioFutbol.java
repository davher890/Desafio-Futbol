...
public class PostDesafioFutbol {
	...
	//
	// public PostDesafioFutbol(String url, LogInActivity c, JSONObject json,
	// String methodCallback){
	// this.url = new
	// StringBuffer(HTTP_WWW_DESAFIOFUTBOL_COM).append(url).toString();
	// this.json = json;
	// this.log = c;
	// this.c = (Context) c;
	...
	// }
	//
	// public PostDesafioFutbol(String url, FragmentEntrenadores fragment,
	// JSONObject json, String methodCallback) {
	...
	// }
	//
	// public PostDesafioFutbol(String url, FragmentFichajes fragment,
	// JSONObject json, String methodCallback) {
	// this.url = new StringBuffer(HTTP_WWW_DESAFIOFUTBOL_COM).
	// append(url).append("?").append("auth_token").append("=").append(DatosUsuario.getToken()).toString();
	// this.c = (Context) fragment.getActivity();
	...
	// }
	//
	// public PostDesafioFutbol(String url, FragmentAlineacion fragment,
	// JSONObject json, String methodCallback) {
	// this.url = new StringBuffer(HTTP_WWW_DESAFIOFUTBOL_COM).
	// append(url).append("?").append("auth_token").append("=").append(DatosUsuario.getToken()).toString();
	// this.c = (Context) fragment.getActivity();
	...
	// if (log != null){
	// try {
	// Method method = c.getClass().getMethod(this.methodCallback,
	// String.class);
