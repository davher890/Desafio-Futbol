...
public class PutDesafioFutbol {
	...
	//
	// public PutDesafioFutbol(String url, FragmentAlineacion fragment,
	// JSONObject json, String methodCallback) {
	// this.url = new StringBuffer(HTTP_WWW_DESAFIOFUTBOL_COM).append(url)
	// .append("?").append("auth_token").append("=")
	// .append(DatosUsuario.getToken()).toString();
	// this.json = json;
